...
| T-0062 | OrderNumberGenerator: TZ-aware year (drops `int year` parameter; reads CountryConfiguration.TimeZoneId) + Postgres Testcontainers harness + race/rollback/first-allocation test coverage. Rescoped from "integration into CreateOrder" since that handler is T-0063 | 4 | S | **ready** | T-0007, T-0010, T-0060 | — | 0009 |
| T-0063 | CreateOrder command + Validator + Handler + customer-host OrdersController; adds RequireEmailConfirmed middleware; 5 new BusinessErrorMessage codes + Czech i18n; persists Order in `PendingPayment` (Comgate session is a follow-up T-0065 call per user decision Q1) | 4 | L | **ready** | T-0060, T-0061, T-0062, T-0033, T-0041, T-0024 | US-customer-0010, 0011 | 0002, 0003, 0005, 0009, 0011, 0013, 0014, 0017 |
