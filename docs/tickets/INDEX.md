...
| T-0005 | Money value object + MoneyFormatter + tests | 1 | S | draft | T-0001 | — | 0003 |
| T-0006 | Auditable base entity + audit interceptor populating CreatedBy/On + UpdatedBy/On from IUserSessionProvider | 1 | S | draft | T-0001, T-0002 | — | 0011 |
...
| T-0011 | Outbox table + IOutbox producer helper + OutboxRepository; AdminAuditLogEntry table + AdminAuditPipelineBehavior | 1 | M | draft | T-0002, T-0006 | — | 0014, 0020 |
...
| T-0016 | Deploy: Bicep templates for Azure (Postgres Flexible Server, four App Services, Functions, Blob, Key Vault, App Insights); staging + production environments; deploy pipeline GitHub Actions | 1 | L | draft | T-0014 | — | 0023 |
...
| T-0031 | IAddressGeocoder + MapboxAddressGeocoder; backend autocomplete proxy with per-user rate limit | 2 | M | draft | T-0030 | — | 0010 |
| T-0032 | ICompanyRegistry + AresCompanyRegistry; IČO format validator (mod-11); company_registry_cache table + 24h TTL; in-memory cache | 2 | M | draft | T-0030 | — | 0018 |
| T-0033 | Maker entity + IMakerRepository; RegisterMaker command (ARES lookup → snapshot → create User+Maker atomically) | 2 | L | draft | T-0020, T-0030, T-0032 | US-maker-0001 | 0010, 0012, 0018 |
| T-0034 | UpdateMakerProfile command + admin's RefreshMakerFromAres + VerifyMaker + DeactivateMaker commands | 2 | M | draft | T-0033 | US-maker-0003, 0015; US-admin-0003, 0004, 0005 | 0014 |
| T-0035 | Frontend: /auth/login, /auth/register (customer + maker entry points), /auth/reset, /auth/verify, /auth/magic; account confirmation banner | 2 | L | draft | T-0024, T-0025, T-0023, T-0026, T-0033 | US-customer-0001–0006; US-maker-0001, 0002 | — |
| T-0036 | Frontend: /dashboard/zakaznik/profile (update profile, change password, log out); /dashboard/maker/profil (update bio/pickup/bank/categories) | 2 | M | draft | T-0035 | US-customer-0018, 0019, 0020; US-maker-0003, 0015, 0016 | — |
