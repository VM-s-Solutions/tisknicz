...
public sealed class PostgresHarness : IAsyncLifetime
{
    ...
    public async Task ResetMutableTablesAsync(CancellationToken cancellationToken = default)
    {
        ...
        await db.Database.ExecuteSqlRawAsync(
            "TRUNCATE TABLE numbering_sequence, invoices, payout_batches, order_messages, disputes, reviews, orders, products, makers, categories, addresses, refresh_tokens, users, outbox_event, admin_audit_log RESTART IDENTITY CASCADE;",
            cancellationToken);
    }
}
