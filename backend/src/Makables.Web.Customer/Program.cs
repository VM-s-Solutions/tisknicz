// Customer API host. Per ADR 0005 (per-audience route groups + hosts) and
...
builder.AddMakablesObservability("makables-customer-api");
...
// not part of the client contract, and leaving them described makes every ops
...
app.MapGet("/", () => "Makables Customer API — alive.").ExcludeFromDescription();
...
namespace Makables.Web.Customer
{
