        ...
        <div className="space-y-6 rounded-2xl border border-zinc-800 bg-surface-card p-6 sm:p-8">
          <section className="space-y-3">
            ...
            <dl className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div>
                ...
                <dd className="mt-1 text-zinc-300">{t('static.contact.operator_ico_value')}</dd>
              </div>
              <div>
                <dt className="text-xs uppercase tracking-wide text-zinc-500">{t('static.contact.operator_address_label')}</dt>
                <dd className="mt-1 text-zinc-300">{t('static.contact.operator_address_value')}</dd>
              </div>
            </dl>
          </section>
          ...
          <section className="space-y-3">
            ...
            <dl>
              ...
              <dd className="mt-1 text-zinc-300">{t('static.contact.operator_email_value')}</dd>
            </dl>
          </section>
        </div>
      </div>
