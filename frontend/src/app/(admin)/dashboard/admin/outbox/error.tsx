...
/**
 * Last-resort error boundary for /dashboard/admin/outbox (T-0118c). The
 * expected-error path (backend reachable, returning an ApiError) surfaces
 * inline via the Result flow; this catches an unhandled render/network
 * throw (T-0118a orders error precedent).
 */
export default function AdminOutboxError({
  reset,
}: {
