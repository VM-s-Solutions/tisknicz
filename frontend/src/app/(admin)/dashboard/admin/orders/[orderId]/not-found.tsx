    ...
    <section className="mx-auto flex max-w-2xl flex-col gap-6 px-4 py-16 sm:px-6 lg:px-8">
      <Card padding="lg" className="flex flex-col items-center gap-4 text-center">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-brand-line px-5 py-2.5 text-sm font-semibold text-brand-ink transition-colors hover:border-brand-500 hover:bg-tint-brand hover:text-on-tint-brand"
        >
