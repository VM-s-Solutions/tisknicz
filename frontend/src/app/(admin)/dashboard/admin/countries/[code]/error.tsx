...
/**
 * Last-resort error boundary for /dashboard/admin/countries/[code]
 * (T-0118c). Expected ApiErrors surface inline via the form's Result flow;
 * this catches an unhandled render/network throw.
 */
export default function AdminCountryConfigError({
  reset,
}: {
