...
/**
 * Route-level error boundary for /dashboard/admin/kategorie (T-0175, audit ADM-H4/L7). The
  ...
  return (
    <section className="py-12 lg:py-16">
      <div className="mx-auto flex max-w-3xl flex-col gap-4 px-4 sm:px-6 lg:px-8">
        <Alert variant="error">
          <p className="font-semibold">{t('dashboard.admin.categories.list.error')}</p>
          <p className="mt-1">{t('dashboard.admin.categories.subtitle')}</p>
        </Alert>
