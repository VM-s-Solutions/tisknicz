...
/**
 * Last-resort error boundary for /dashboard/admin/makers/[id] (T-0140).
 * Expected ApiErrors surface inline via the form's Result flow; this
 * catches an unhandled render/network throw.
 */
export default function AdminMakerFeeOverrideError({
  reset,
}: {
