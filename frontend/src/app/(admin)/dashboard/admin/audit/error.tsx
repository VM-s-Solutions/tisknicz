...
/**
 * Route-level error boundary for the admin audit-log list (T-0118a).
 * Last-resort surface — the expected ApiError path renders inline.
 */
    ...
    <section className="py-12 lg:py-16">
      <div className="mx-auto flex max-w-3xl flex-col gap-4 px-4 sm:px-6 lg:px-8">
        <Alert variant="error">
          ...
          <p className="mt-1">{t('dashboard.admin.audit.error.body')}</p>
        </Alert>
