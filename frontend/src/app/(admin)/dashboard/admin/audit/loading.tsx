/**
 * Route-segment skeleton for /dashboard/admin/audit (T-0118a) — heading,
 * filter bar and row placeholders mirroring the list layout.
 */
    ...
    <section className="py-12 lg:py-16">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-3">
          <div className="h-16 animate-pulse rounded-2xl border border-zinc-800 bg-surface-card" />
          <div className="h-16 animate-pulse rounded-2xl border border-zinc-800 bg-surface-card" />
          <div className="h-16 animate-pulse rounded-2xl border border-zinc-800 bg-surface-card" />
          <div className="h-16 animate-pulse rounded-2xl border border-zinc-800 bg-surface-card" />
        </div>
