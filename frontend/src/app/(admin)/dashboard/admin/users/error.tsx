...
/**
 * Last-resort error boundary for /dashboard/admin/users (T-0118c). The
 * erase Result flow surfaces expected ApiErrors inline (including the
 * delete-user verdicts); this catches an unhandled render/network throw.
 */
