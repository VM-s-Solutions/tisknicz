    ...
    <Alert variant="error">
      <div className="flex flex-col gap-3">
        ...
        <Link
          ...
          className="inline-flex w-fit items-center gap-2 rounded-lg border border-error/40 px-4 py-2 text-sm font-semibold text-error transition-colors duration-150 hover:border-error/40 hover:text-error"
        >
