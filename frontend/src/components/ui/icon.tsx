...
const icons = {
  ...
  apple: (
    <path
      d="M16.365 1.43c0 1.14-.475 2.25-1.235 3.03-.79.83-2.06 1.47-3.06 1.39-.13-1.09.46-2.28 1.19-3.02.81-.83 2.19-1.45 3.1-1.4zM20.6 17.2c-.53 1.2-.78 1.73-1.46 2.79-.94 1.47-2.27 3.31-3.92 3.32-1.47.02-1.85-.96-3.84-.95-1.99.01-2.4.97-3.87.95-1.65-.02-2.9-1.66-3.84-3.13-2.65-4.09-2.93-8.9-1.29-11.46 1.16-1.82 3-2.89 4.71-2.89 1.75 0 2.85 1 4.3 1 1.4 0 2.25-1 4.3-1 1.53 0 3.15.83 4.3 2.28-3.78 2.08-3.17 7.47.61 9.09z"
      fill="currentColor"
      stroke="none"
    />
  ),
