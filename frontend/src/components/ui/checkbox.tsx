    ...
    <div className={`flex flex-col gap-1.5 ${className}`}>
      ...
      >
        <span className="relative mt-0.5 inline-flex h-5 w-5 shrink-0">
          ...
          <span
            aria-hidden="true"
            className="pointer-events-none absolute inset-0 flex items-center justify-center text-zinc-950 opacity-0 transition-opacity duration-150 peer-checked:opacity-100"
          >
