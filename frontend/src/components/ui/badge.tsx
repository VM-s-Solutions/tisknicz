...
const variantStyles: Record<NonNullable<BadgeProps['variant']>, { chip: string; dot: string }> = {
  ...
  info: { chip: 'border-info/30 bg-tint-info text-on-tint-info', dot: 'bg-info' },
  success: { chip: 'border-success/30 bg-tint-success text-on-tint-success', dot: 'bg-success' },
  warning: { chip: 'border-warning/30 bg-tint-warning text-on-tint-warning', dot: 'bg-warning' },
  error: { chip: 'border-error/30 bg-tint-error text-on-tint-error', dot: 'bg-error' },
  brand: { chip: 'border-brand-500/40 bg-tint-brand text-on-tint-brand', dot: 'bg-brand-400' },
};
